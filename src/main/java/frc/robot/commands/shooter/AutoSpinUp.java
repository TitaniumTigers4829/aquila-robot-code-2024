...
public class AutoSpinUp extends DriveCommandBase {
  ...
  public AutoSpinUp(DriveSubsystem driveSubsystem, ShooterSubsystem shooterSubsystem, PivotSubsystem pivotSubsystem, VisionSubsystem visionSubsystem, DoubleSupplier leftX, DoubleSupplier leftY, DoubleSupplier rightX, BooleanSupplier isFieldRelative, LEDSubsystem leds) {
