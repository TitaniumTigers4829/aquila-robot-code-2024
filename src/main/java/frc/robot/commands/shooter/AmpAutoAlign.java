...
// public class AmpAutoAlign extends DriveCommandBase {
...
//   public AmpAutoAlign(DriveSubsystem driveSubsystem, ShooterSubsystem shooterSubsystem, PivotSubsystem pivotSubsystem, VisionSubsystem visionSubsystem, DoubleSupplier leftX, DoubleSupplier leftY, BooleanSupplier isFieldRelative, LEDSubsystem leds) {
...
//     double distance = robotPos.getTranslation(ampPos);
//     // arctangent for desired heading
//     // if (isRed) {
//     //   desiredHeading = Math.atan2((speakerPos.getY() - robotPos.getY()), (speakerPos.getX() - robotPos.getX()));
//     // } else {
//       desiredHeading = Math.atan2((robotPos.getY() - ampPos.getY()), (robotPos.getX() - ampPos.getX()));
//       // }
