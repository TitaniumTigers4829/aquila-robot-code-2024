...
public class BlueSevenNoteAuto extends SequentialCommandGroup {
  /** Creates a new BlueSixNoteAuto. */
  public BlueSevenNoteAuto(DriveSubsystem driveSubsystem, VisionSubsystem visionSubsystem, IntakeSubsystem intakeSubsystem, PivotSubsystem pivotSubsystem, ShooterSubsystem shooterSubsystem, LEDSubsystem ledSubsystem) {
    ...
    addCommands(
      ...
      new ShootSpeakerAuto(driveSubsystem, shooterSubsystem, visionSubsystem, pivotSubsystem).withTimeout(2),
      new ParallelRaceGroup(
        new FollowChoreoTrajectory(driveSubsystem, visionSubsystem, "blue note 5 to 6").withTimeout(3),
        new TowerIntake(intakeSubsystem, pivotSubsystem, shooterSubsystem, ledSubsystem)
      ),
      new ShootSpeakerAuto(driveSubsystem, shooterSubsystem, visionSubsystem, pivotSubsystem).withTimeout(2)
    );
