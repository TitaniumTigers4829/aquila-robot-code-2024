    ...
    addCommands(
            ...
            () ->
                driveSubsystem.resetOdometry(
                    new Pose2d(
                        15.752967834472656,
                        6.664938449859619,
                        Rotation2d.fromRadians(2.0491481821878663)))),
        new SubwooferShot(
                driveSubsystem,
                shooterSubsystem,
                pivotSubsystem,
        ...
        new ParallelCommandGroup(
            new FollowChoreoTrajectory(
                driveSubsystem, visionSubsystem, "red amp side four note 1", false),
        ...
        new ParallelCommandGroup(
            new FollowChoreoTrajectory(
                driveSubsystem, visionSubsystem, "red amp side four note 2", false),
            new IntakeAuto(intakeSubsystem, pivotSubsystem, shooterSubsystem, ledSubsystem)
                .withTimeout(2.8)),
        new FollowChoreoTrajectory(
            driveSubsystem, visionSubsystem, "red amp side four note 3", false),
        new ShootSpeakerAuto(
                driveSubsystem,
                shooterSubsystem,
                pivotSubsystem,
