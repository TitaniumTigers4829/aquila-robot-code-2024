...
public class BluteNoteOneFour extends SequentialCommandGroup {
  /** Creates a new BluteNoteOneFour. */
  public BluteNoteOneFour(DriveSubsystem driveSubsystem, VisionSubsystem visionSubsystem, IntakeSubsystem intakeSubsystem, ShooterSubsystem shooterSubsystem, PivotSubsystem pivotSubsystem, LEDSubsystem leds) {
  addCommands(
    ...
    // new FollowChoreoTrajectory(driveSubsystem, visionSubsystem, getName(), isScheduled())
    // new ShootSpeakerAuto(driveSubsystem, shooterSubsystem, pivotSubsystem, visionSubsystem, leds).withTimeout(3)
  );
  }
}
