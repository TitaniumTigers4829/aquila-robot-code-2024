...
public class BlueNoteEight1 extends SequentialCommandGroup {
  /** Creates a new BlueNoteEight1. */
  public BlueNoteEight1(DriveSubsystem driveSubsystem, VisionSubsystem visionSubsystem, IntakeSubsystem intakeSubsystem, PivotSubsystem pivotSubsystem, ShooterSubsystem shooterSubsystem) {
