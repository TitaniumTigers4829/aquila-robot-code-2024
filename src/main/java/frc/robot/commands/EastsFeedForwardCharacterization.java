...
import frc.robot.extras.MultiLinearRegression;
...
public class EastsFeedForwardCharacterization extends Command {
  ...
  public EastsFeedForwardCharacterization(
  ...
  public static class FeedForwardCharacterizationData {
    ...
    public void print() {
      ...
      MultiLinearRegression regression2 = new MultiLinearRegression(x, y);
