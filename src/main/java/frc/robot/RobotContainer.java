...
import frc.robot.commands.shooter.ShootCurrentAngle;
...
public class RobotContainer {
  ...
  private final Joystick buttonBoardController =
      new Joystick(JoystickConstants.BUTTON_BOARD_JOYSTICK_ID);
  ...
  public RobotContainer() {
    ...
    autoChooser.addOption(
        ...
        new BlueFiveNote(
            ...
            ledSubsystem));
    autoChooser.addOption(
        "red under stage 4 note",
        new RedUnderStage4Note(
            driveSubsystem,
            visionSubsystem,
            pivotSubsystem,
            shooterSubsystem,
            ...
            ledSubsystem));
    autoChooser.addOption(
        "blue under stage 4 note",
        new BlueUnderStage4Note(
            driveSubsystem,
            visionSubsystem,
            pivotSubsystem,
            shooterSubsystem,
            intakeSubsystem,
            ledSubsystem));
    // autoChooser.addOption("red far 3 note", new RedFar3Note(driveSubsystem, visionSubsystem,
    // pivotSubsystem, shooterSubsystem, intakeSubsystem));
    autoChooser.addOption(
        "red six",
        new RedSixNote(
            driveSubsystem,
  ...
  private void configureButtonBindings() {
    ...
    JoystickButton buttonBoardYButton =
        new JoystickButton(buttonBoardController, JoystickConstants.Y_BUTTON_ID);
    DoubleSupplier buttonBoardJoystickY =
        () -> buttonBoardController.getRawAxis(JoystickConstants.LEFT_STICK_Y_ID);
    DoubleSupplier buttonBoardJoystickX =
        () -> buttonBoardController.getRawAxis(JoystickConstants.LEFT_STICK_X_ID);
    ...
    Command driveCommand =
        new Drive(
            ...
            () -> 0,
            () -> 0,
            () -> Util.modifyAxis(buttonBoardJoystickX, 1),
    ...
    operatorLeftTrigger.whileTrue(
        new TowerIntake(
            ...
            ledSubsystem,
            this::intakeCallback));
    operatorLeftTrigger.whileFalse(
        new TowerIntake(
                intakeSubsystem,
                pivotSubsystem,
                shooterSubsystem,
    ...
    buttonBoardYButton.whileTrue(new ShootCurrentAngle(shooterSubsystem));
    operatorYButton.whileTrue(
        new ManualPivot(pivotSubsystem, () -> Util.modifyAxis(buttonBoardJoystickY, 2)));
